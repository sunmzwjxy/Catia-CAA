...
HRESULT CMCreateGTOSystemCmd::CreateDELGTOSystem()
{
	...
	*/
	...
	/******************************************************************/
	CATUnicodeString strWorkLevelCombo = CUSCAAUtilService::GetSelectComboValue(_Panel->GetCombo(ID_WorkLevelCombo));
	if (strWorkLevelCombo.SearchSubString("Key") != -1) strWorkLevelCombo = "Key";
	else if (strWorkLevelCombo.SearchSubString("Important") != -1) strWorkLevelCombo = "Important";
	else strWorkLevelCombo = "General";

	CATUnicodeString strWorkAreaCombo = CUSCAAUtilService::GetSelectComboValue(_Panel->GetCombo(ID_WorkAreaCombo));
	if (strWorkAreaCombo.SearchSubString("ZJS") != -1) strWorkAreaCombo = "ZJS";
	else if (strWorkAreaCombo.SearchSubString("JT") != -1) strWorkAreaCombo = "JT";
	else if (strWorkAreaCombo.SearchSubString("QJS") != -1) strWorkAreaCombo = "QJS";
	else if (strWorkAreaCombo.SearchSubString("HJS") != -1) strWorkAreaCombo = "HJS";
	else if (strWorkAreaCombo.SearchSubString("PW") != -1) strWorkAreaCombo = "PW";
	else if (strWorkAreaCombo.SearchSubString("CW") != -1) strWorkAreaCombo = "CW";
	else strWorkAreaCombo = "JY";



	CUSCAAUtilService::SetObjectAttrString(spNewGTOSystemRef, "CUS_GTO_WorkArea", strWorkAreaCombo);
	CUSCAAUtilService::SetObjectAttrString(spNewGTOSystemRef, "CUS_GTO_WORKLevel", strWorkLevelCombo);
