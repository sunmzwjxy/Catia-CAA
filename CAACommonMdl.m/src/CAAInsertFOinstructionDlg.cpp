...
// ----------------------------------------
#include "CAAInsertFOinstructionDlg.h"
...
CAAInsertFOinstructionDlg::CAAInsertFOinstructionDlg(CATDialog* iParent, const CATString& iName)
...
CAAInsertFOinstructionDlg::~CAAInsertFOinstructionDlg()
{
...
void CAAInsertFOinstructionDlg::Build()
{
...
// Begin of User Code
CATDlgEditor* CAAInsertFOinstructionDlg::GetEditor(int iCtrlID)
{
...
CATDlgCheckButton* CAAInsertFOinstructionDlg::GetCheckButton(int iCtrlID)
{
