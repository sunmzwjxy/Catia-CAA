//===================================================================
// COPYRIGHT CAA 2021/12/13
//===================================================================
// CAAInsertFOinstructionCmd.cpp
// Header definition of class CAAInsertFOinstructionCmd
//===================================================================
//
// Usage notes:
//
...
#include "CAAInsertFOinstructionCmd.h"
#include "CATCreateExternalObject.h"
CATCreateClass(CAAInsertFOinstructionCmd);
...
//-----------------------------------------------------------------------------
CAAInsertFOinstructionCmd::CAAInsertFOinstructionCmd() :
	CATStateCommand("CAAInsertFOinstructionCmd", CATDlgEngOneShot, CATCommandModeShared)
	, _OKAgent(NULL),
	_ApplyAgent(NULL),
	_CloseAgent(NULL)
{
	...
	_Panel = new CAAInsertFOinstructionDlg(pWnd, "Insert FO & instruction");
	_Panel->Build();
...
void CAAInsertFOinstructionCmd::BuildGraph()
{
	...
	AddTransition(pSelectionState, NULL, AndCondition(IsOutputSetCondition(_OKAgent), Condition((ConditionMethod)&CAAInsertFOinstructionCmd::OKAction)), NULL);
	//AddTransition(pSelectionState, NULL, IsOutputSetCondition(_OKAgent), Action((ActionMethod)&CAAInsertFOinstructionCmd::OKAction));

	// Transition from Input state to NULL, when click on Cancel button
	AddTransition(pSelectionState, pSelectionState, IsOutputSetCondition(_ApplyAgent), Action((ActionMethod)&CAAInsertFOinstructionCmd::ApplyAction));

	// Transition from Input state to NULL, when click on Close button
	AddTransition(pSelectionState, NULL, IsOutputSetCondition(_CloseAgent), Action((ActionMethod)&CAAInsertFOinstructionCmd::CancelAction));

	AddTransition(pSelectionState, NULL, IsOutputSetCondition(_CancleAgent), Action((ActionMethod)&CAAInsertFOinstructionCmd::CancelAction));

	AddTransition(pSelectionState, pSelectionState, IsOutputSetCondition(_pSelectAgent), Action((ActionMethod)&CAAInsertFOinstructionCmd::ElementSelection, NULL, NULL, (void*)1));

	_pCheckBtn = _Panel->GetCheckButton(ID_ConcurrentOPChectBtn);
	AddAnalyseNotificationCB(_pCheckBtn, _pCheckBtn->GetChkBModifyNotification(), (CATCommandMethod)&CAAInsertFOinstructionCmd::ChangeChkBtn, NULL);
	...
	//	(CATCommandMethod)&CAAInsertFOinstructionCmd::ChangeRadioNotifyCopy, NULL);
	...
	//	(CATCommandMethod)&CAAInsertFOinstructionCmd::ChangeRadioNotifyInput, NULL);
...
CATBoolean CAAInsertFOinstructionCmd::ChangeChkBtn(void *data)
{
...
// ActionOne ()
//-------------------------------------------------------------------------
CATBoolean CAAInsertFOinstructionCmd::ActionOne(void *data)
{
...
CATBoolean CAAInsertFOinstructionCmd::ElementSelection(void * data)
{
...
void CAAInsertFOinstructionCmd::FilterSelectObject()
{
...
CATBoolean CAAInsertFOinstructionCmd::ApplyAction(void *data)
{
	if (_ApplyAgent)
	{
...
CATBoolean CAAInsertFOinstructionCmd::OKAction(void *data)
{
	if (_OKAgent)
	{
...
CATBoolean CAAInsertFOinstructionCmd::CheckSelectObject()
{
...
CATBoolean CAAInsertFOinstructionCmd::CancelAction(void *data)
{
...
HRESULT CAAInsertFOinstructionCmd::InsertFOinstruction()
{
	HRESULT rc = E_FAIL;
...
bool  CAAInsertFOinstructionCmd::IsOPTitleExisted(CATUnicodeString iStrTitle, CATIPLMNavReference * ipFO_OPFatherRef)
{
...
CATUnicodeString CAAInsertFOinstructionCmd::findDifferTitle(CATUnicodeString isFormatCode, CATListOfCATUnicodeString iTitlList)
{
...
void CAAInsertFOinstructionCmd::CreateOneOPInstruction(CATIPLMNavOccurrence *ipFO_OPFatherOcc, CATIPLMNavReference* ipFO_OPFatherRef,CATUnicodeString istrRefsuffix, CATUnicodeString istrInstsuffix)
{
...
bool CAAInsertFOinstructionCmd::ifNameConformToRule(CATUnicodeString isStartingOprationName, OpNameSplitInfo &onfoOpName)
{
...
HRESULT CAAInsertFOinstructionCmd::startCreateAction(CATListOfCATUnicodeString istrExistedOPTitleList,
