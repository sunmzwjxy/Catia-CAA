...
//===================================================================
// CAAGenerateBOMCmd.cpp
// Header definition of class CAAGenerateBOMCmd
//===================================================================
//
// Usage notes:
//
...
#include "CAAGenerateBOMCmd.h"
#include "CATCreateExternalObject.h"
CATCreateClass(CAAGenerateBOMCmd);
...
//-----------------------------------------------------------------------------
CAAGenerateBOMCmd::CAAGenerateBOMCmd() :
	CATStateCommand("CAAGenerateBOMCmd", CATDlgEngOneShot, CATCommandModeShared)
	, _OKAgent(NULL),
	_ApplyAgent(NULL),
	_CloseAgent(NULL)
{
	...
	_Panel = new CAAGenerateBOMDlg(pWnd, "MBOM ManufacturingPart");
	_Panel->Build();
...
void CAAGenerateBOMCmd::BuildGraph()
{
	...
	AddTransition(pSelectionState, NULL, AndCondition(IsOutputSetCondition(_OKAgent), Condition((ConditionMethod)&CAAGenerateBOMCmd::OKAction)), NULL);

	// Transition from Input state to NULL, when click on Cancel button
	AddTransition(pSelectionState, pSelectionState, IsOutputSetCondition(_ApplyAgent), Action((ActionMethod)&CAAGenerateBOMCmd::ApplyAction));

	// Transition from Input state to NULL, when click on Close button
	AddTransition(pSelectionState, NULL, IsOutputSetCondition(_CloseAgent), Action((ActionMethod)&CAAGenerateBOMCmd::CancelAction));

	AddTransition(pSelectionState, NULL, IsOutputSetCondition(_CancleAgent), Action((ActionMethod)&CAAGenerateBOMCmd::CancelAction));

	AddTransition(pSelectionState, pSelectionState, IsOutputSetCondition(_pSelectAgent), Action((ActionMethod)&CAAGenerateBOMCmd::ElementSelection, NULL, NULL, (void*)1));
	...
	//	(CATCommandMethod)&CAAGenerateBOMCmd::ChangeRadioNotifyCopy, NULL);
	...
	//	(CATCommandMethod)&CAAGenerateBOMCmd::ChangeRadioNotifyInput, NULL);
...
// ActionOne ()
//-------------------------------------------------------------------------
CATBoolean CAAGenerateBOMCmd::ActionOne(void *data)
{
...
//CATBoolean CAAGenerateBOMCmd::ChangeRadioNotifyCopy(void *data)
//{
//	// TODO: Define the action associated with the transition
//	// ------------------------------------------------------
...
//CATBoolean CAAGenerateBOMCmd::ChangeRadioNotifyInput(void *data)
//{
//	// TODO: Define the action associated with the transition
//	// ------------------------------------------------------
//	CATDlgEditor *pDesignCodeEditor = _Panel->GetEditor(ID_SelectMAEditor);
...
CATBoolean CAAGenerateBOMCmd::ElementSelection(void * data)
{
...
void CAAGenerateBOMCmd::FilterSelectObject()
{
...
CATBoolean CAAGenerateBOMCmd::ApplyAction(void *data)
{
	if (_ApplyAgent)
	{
...
CATBoolean CAAGenerateBOMCmd::OKAction(void *data)
{
	if (_OKAgent)
	{
...
CATBoolean CAAGenerateBOMCmd::CheckSelectObject()
{
...
CATBoolean CAAGenerateBOMCmd::CancelAction(void *data)
{
...
HRESULT CAAGenerateBOMCmd::CrateMbomStructure()
{
	HRESULT rc = E_FAIL;
...
HRESULT CAAGenerateBOMCmd::AddOneBlankProduct(CATIPLMNavReference * ipProductFatherRef, CATUnicodeString iStrPartNo, CATUnicodeString iStrInstName, CATBaseUnknown *& opPrdInstanceBU)
{
	HRESULT rc = E_FAIL;
...
HRESULT CAAGenerateBOMCmd::BrowseMARef2CADTree(CATIPLMNavOccurrence* ipMAOcc, CATIPLMNavOccurrence * iRootProcessOcc, int iDepth, CATIPLMNavReference * ipProductFatherRef )
{
...
CATIPLMNavOccurrence_var CAAGenerateBOMCmd::GetOccFromRef(CATIPLMNavOccurrence_var ispOccOnFarther, CATIPLMNavReference_var ispRef)
{
...
CATIPLMNavReference_var  CAAGenerateBOMCmd::FromBUToRef(CATBaseUnknown * ipNewProdBU)			// BU 转到 ref，ko？
{
...
void CAAGenerateBOMCmd::DeleteFeature(CATBaseUnknown_var spObj)
{
...
void CAAGenerateBOMCmd::UpdateFeature(CATBaseUnknown_var spObj)
{
	CATIUseEntity_var spUseEntity = spObj;
	if (NULL_var != spUseEntity)
	{
...
void CAAGenerateBOMCmd::ReleasePtr(CATBaseUnknown * piCBU)
{
	if (NULL != piCBU)
	{
		piCBU->Release();
...
int CAAGenerateBOMCmd::FindReference(CATOmbLifeCycleRootsBag & iLifeCycleBag,
...
HRESULT CAAGenerateBOMCmd::GetOccurrenceFromProcessReference(
...
HRESULT CAAGenerateBOMCmd::CAAMmrGetPartFromProduct(CATIPLMNavInstance_var   spNavInstance, CATIPartRequest_var  & ospPartFromProduct)
...
HRESULT CAAGenerateBOMCmd::CAAMmrGetGeometry(CATIPartRequest_var ispModelPart, const CATUnicodeString iInputName,
...
CATUnicodeString CAAGenerateBOMCmd::GetAliasName(CATBaseUnknown * ipBaseUnknown)
{
