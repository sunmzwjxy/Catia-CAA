...
CAAGenerateBOMDlg::CAAGenerateBOMDlg(CATDialog* iParent, const CATString& iName)
...
CAAGenerateBOMDlg::~CAAGenerateBOMDlg()
{
...
// Begin of User Code
CATDlgEditor* CAAGenerateBOMDlg::GetEditor(int iCtrlID)
{
...
/*
CATDlgRadioButton* CAAGenerateBOMDlg::GetRadioButton(int iCtrlID)
{
...
CATDlgCombo* CAAGenerateBOMDlg::GetCombo(int iCtrlID)
{
