...
static CATIPLMComponent_var GetCurrentPPRComp();

static CATLISTV(CATBaseUnknown_var) GetCurrentPPRSList(unsigned long iType);
...
static bool CheckEffectivityRange(const CATUnicodeString iFatherEffectivity, const CATUnicodeString iEffectivity);

static bool CheckEffectivityIntersection(const CATUnicodeString iEffectivity, const CATUnicodeString iOtherEffectivity);
...
static void AddExtensionByEKL(CATIPLMNavReference_var& spObjectRef, CATUnicodeString iExtensionName);

static HRESULT GetPLMAttributeValue(CATIAdpPLMIdentificator* pObjAdpIdent, const CATUnicodeString& iStrPLMType, const CATUnicodeString& iStrAttrName, CATUnicodeString& oStrAttrValue);
...
static void PathElementString(CATPathElement * ipPath, CATUnicodeString & oPathName);

static CATUnicodeString GetServerURIFromEKL(CATBaseUnknown_var spObject);
