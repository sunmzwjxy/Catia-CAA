...
// ----------------------------------------
#include "CAAReNameOperationsDlg.h"
...
CAAReNameOperationsDlg::CAAReNameOperationsDlg(CATDialog* iParent, const CATString& iName)
...
CAAReNameOperationsDlg::~CAAReNameOperationsDlg()
{
...
void CAAReNameOperationsDlg::Build()
{
...
// Begin of User Code
CATDlgEditor* CAAReNameOperationsDlg::GetEditor(int iCtrlID)
{
...
//
//CATDlgCheckButton* CAAReNameOperationsDlg::GetCheckButton(int iCtrlID)
//{
