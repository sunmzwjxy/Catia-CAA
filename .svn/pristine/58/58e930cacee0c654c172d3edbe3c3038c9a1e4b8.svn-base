...
private:
    ...
    struct ShortString {
		...
		//enum { MaxChars = 2048, MaxSize = MaxChars - 1, LenPos = MaxSize };
        Ch str[MaxChars];
...
//         inline SizeType GetLength() const       { return  static_cast<SizeType>(MaxSize -  str[LenPos]); }
        ...
        inline static bool Usable(SizeType len) { return                       (MaxChars - 1 >= len); }
        inline void     SetLength(SizeType len) { str[MaxChars - 1] = static_cast<Ch>(MaxChars - 1 -  len); }
        inline SizeType GetLength() const       { return  static_cast<SizeType>(MaxChars - 1 -  str[MaxChars]); }
