...
CAANewVersionDlg::CAANewVersionDlg(CATDialog* iParent, const CATString& iName)
...
CAANewVersionDlg::~CAANewVersionDlg()
{
...
// Begin of User Code
CATDlgEditor* CAANewVersionDlg::GetEditor(int iCtrlID)
{
...
//
//CATDlgCheckButton* CAANewVersionDlg::GetCheckButton(int iCtrlID)
//{
